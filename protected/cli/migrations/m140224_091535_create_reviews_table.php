<?php
/**
 * Миграция m140224_091535_create_reviews_table
 *
 * @property string $prefix
 */
 
class m140224_091535_create_reviews_table extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{create_reviews_table}}');
 
    public function safeUp()
    {
        $this->_checkTables();
 
        $this->createTable('{{create_reviews_table}}', array(
