...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
    ...
    'afterAjaxUpdate'=>"function() {sortGrid('certificate')}",
...
<?php if($model->hasAttribute('sort')) Yii::app()->clientScript->registerScript('sortGrid', 'sortGrid("certificate");', CClientScript::POS_END) ;?>